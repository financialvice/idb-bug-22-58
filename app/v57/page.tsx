...
import { i, id, init } from "instantdb-57";
...
export default function V57Page() {
    ...
    <div className="min-h-screen bg-gray-950 p-6 text-white">
      <div className="mx-auto max-w-2xl">
        ...
        <div className="mb-6 flex items-center justify-between">
          <div>
            <h1 className="font-bold text-xl">v0.22.57</h1>
            <p className="text-green-400 text-sm">Working version</p>
          </div>
          <div className="flex gap-2">
            <a href="/v58" className="rounded bg-gray-800 px-3 py-1.5 text-sm hover:bg-gray-700">
              Switch to v58
            </a>
              ...
              <div key={todo.id} className="rounded border border-gray-800 bg-gray-900 p-4">
                ...
                <div className="space-y-2">
                  <div className="flex items-center gap-2">
                    <span className="w-28 text-gray-400 text-xs">With setState:</span>
                    <button
                  ...
                  <div className="flex items-center gap-2">
                    <span className="w-28 text-gray-400 text-xs">No setState:</span>
                    <button
        ...
        {/* Explanation */}
        <div className="mt-6 rounded border border-green-900/50 bg-green-950/20 p-4 text-xs text-gray-400">
          <p className="mb-2 font-medium text-green-400">All buttons work correctly in this version</p>
          <p>
            Both "with setState" and "no setState" buttons work as expected.
            React state updates don't interfere with InstantDB's reactivity.
          </p>
        </div>
      </div>
    </div>
